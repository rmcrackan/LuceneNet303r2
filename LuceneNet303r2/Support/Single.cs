...
namespace Lucene.Net.Support
{
    ...
    public class Single
    {
        ...
        {
            if (s.EndsWith("f") || s.EndsWith("F"))
                return float.Parse(s.Substring(0, s.Length - 1), provider);
            else
        ...
        {
            if (s.EndsWith("f") || s.EndsWith("F"))
                return float.Parse(s.Substring(0, s.Length - 1), style);
            else
        ...
        {
            if (s.EndsWith("f") || s.EndsWith("F"))
                return float.Parse(s.Substring(0, s.Length - 1).Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator));
            else
                return float.Parse(s.Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator));
        }
        ...
        public static bool TryParse(string s, out float f)
        {
            ...
            if (s.EndsWith("f") || s.EndsWith("F"))
                ok = float.TryParse(s.Substring(0, s.Length - 1).Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator), out f);
            else
                ok = float.TryParse(s.Replace(".", CultureInfo.CurrentCulture.NumberFormat.NumberDecimalSeparator), out f);
