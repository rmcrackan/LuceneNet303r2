...
namespace Lucene.Net.Documents
{
	...
	public sealed class NumericField:AbstractField
	{
		...
		/// </param>
		public NumericField(string name):this(name, NumericUtils.PRECISION_STEP_DEFAULT, Field.Store.NO, true)
		{
		}
		...
		/// </param>
		public NumericField(string name, Field.Store store, bool index):this(name, NumericUtils.PRECISION_STEP_DEFAULT, store, index)
		{
		}
		...
		/// </param>
		public NumericField(string name, int precisionStep):this(name, precisionStep, Field.Store.NO, true)
		{
		}
		...
		/// <param name="index">if the field should be indexed using <see cref="NumericTokenStream" />
		/// </param>
		public NumericField(string name, int precisionStep, Field.Store store, bool index):base(name, store, index?Field.Index.ANALYZED_NO_NORMS:Field.Index.NO, Field.TermVector.NO)
		{
