...
namespace Lucene.Net.Documents
{
	...
	public abstract class AbstractField : IFieldable
	{
		...
		protected internal string internalName = "body";
		...
		protected internal AbstractField(string name, Field.Store store, Field.Index index, Field.TermVector termVector)
		{
			if (name == null)
