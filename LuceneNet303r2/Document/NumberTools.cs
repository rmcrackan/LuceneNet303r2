...
namespace Lucene.Net.Documents
{
	...
	public class NumberTools
	{
		...
		public static readonly string MIN_STRING_VALUE = NEGATIVE_PREFIX + "0000000000000";
#else
...
#if !PRE_LUCENE_NET_2_0_0_COMPATIBLE
		public static readonly string MAX_STRING_VALUE = POSITIVE_PREFIX + "1y2p0ij32e8e7";
#else
