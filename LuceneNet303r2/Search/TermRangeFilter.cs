...
namespace Lucene.Net.Search
{
	...
	public class TermRangeFilter:MultiTermQueryWrapperFilter<TermRangeQuery>
	{
		...
		/// and includeUpper)
		/// </summary>
		public TermRangeFilter(string fieldName, string lowerTerm, string upperTerm, bool includeLower, bool includeUpper):base(new TermRangeQuery(fieldName, lowerTerm, upperTerm, includeLower, includeUpper))
		{
		}
	    ...
	    /// and includeUpper)
	    /// </summary>
	    public TermRangeFilter(string fieldName, string lowerTerm, string upperTerm, bool includeLower, bool includeUpper, System.Globalization.CompareInfo collator):base(new TermRangeQuery(fieldName, lowerTerm, upperTerm, includeLower, includeUpper, collator))
		{
		}
