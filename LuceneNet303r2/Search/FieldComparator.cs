...
namespace Lucene.Net.Search
{
	...
	public abstract class FieldComparator
	{
		...
		public sealed class StringComparatorLocale:FieldComparator
		{
			...
			internal StringComparatorLocale(int numHits, string field, System.Globalization.CultureInfo locale)
			{
			...
			public override int CompareBottom(int doc)
			{
				string val2 = currentReaderValues[doc];
				if (bottom == null)
				{
					if (val2 == null)
					{
		...
		public sealed class StringOrdValComparator:FieldComparator
		{
			...
			private void  Convert(int slot)
			{
				...
				int index = 0;
				string value_Renamed = values[slot];
		...
		public sealed class StringValComparator:FieldComparator
		{
			...
			internal StringValComparator(int numHits, string field)
			{
				values = new string[numHits];
				this.field = field;
			}
