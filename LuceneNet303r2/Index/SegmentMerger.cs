...
namespace Lucene.Net.Index
{
	...
	public sealed class SegmentMerger
	{
		...
		/// </param>
		public /*internal*/ SegmentMerger(Directory dir, string name)
		{
			InitBlock();
			directory = dir;
			segment = name;
		...
		internal SegmentMerger(IndexWriter writer, string name, MergePolicy.OneMerge merge)
		{
			InitBlock();
        ...
        public /*internal*/ ICollection<string> CreateCompoundFile(string fileName)
        {
		...
		private int MergeFields()
		{
			...
			if (mergeDocStores)
			{
				...
				string fileName = segment + "." + IndexFileNames.FIELDS_INDEX_EXTENSION;
		...
		private void  MergeVectors()
		{
			...
			string fileName = segment + "." + IndexFileNames.VECTORS_INDEX_EXTENSION;
