...
namespace Lucene.Net.Index
{
	...
	public sealed class SegmentInfo : System.ICloneable
	{
		...
		public SegmentInfo(string name, int docCount, Directory dir, bool isCompoundFile, bool hasSingleNormFile):this(name, docCount, dir, isCompoundFile, hasSingleNormFile, - 1, null, false, true)
		{
		}
		
		public SegmentInfo(string name, int docCount, Directory dir, bool isCompoundFile, bool hasSingleNormFile, int docStoreOffset, string docStoreSegment, bool docStoreIsCompoundFile, bool hasProx):this(name, docCount, dir)
		{
	    ...
	    private void  AddIfExists(IList<string> files, string fileName)
		{
