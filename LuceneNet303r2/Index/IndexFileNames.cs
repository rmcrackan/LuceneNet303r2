...
namespace Lucene.Net.Index
{
	...
	public sealed class IndexFileNames
	{
		...
		public /*internal*/ const string SEGMENTS = "segments";
		
		/// <summary>Name of the generation reference file name </summary>
		public /*internal*/ const string SEGMENTS_GEN = "segments.gen";
		
		/// <summary>Name of the index deletable file (only used in
		/// pre-lockless indices) 
		/// </summary>
		public /*internal*/ const string DELETABLE = "deletable";
		
		/// <summary>Extension of norms file </summary>
		public /*internal*/ const string NORMS_EXTENSION = "nrm";
		
		/// <summary>Extension of freq postings file </summary>
		public /*internal*/ const string FREQ_EXTENSION = "frq";
		
		/// <summary>Extension of prox postings file </summary>
		public /*internal*/ const string PROX_EXTENSION = "prx";
		
		/// <summary>Extension of terms file </summary>
		public /*internal*/ const string TERMS_EXTENSION = "tis";
		
		/// <summary>Extension of terms index file </summary>
		public /*internal*/ const string TERMS_INDEX_EXTENSION = "tii";
		
		/// <summary>Extension of stored fields index file </summary>
		public /*internal*/ const string FIELDS_INDEX_EXTENSION = "fdx";
		
		/// <summary>Extension of stored fields file </summary>
		public /*internal*/ const string FIELDS_EXTENSION = "fdt";
		
		/// <summary>Extension of vectors fields file </summary>
		public /*internal*/ const string VECTORS_FIELDS_EXTENSION = "tvf";
		
		/// <summary>Extension of vectors documents file </summary>
		public /*internal*/ const string VECTORS_DOCUMENTS_EXTENSION = "tvd";
		
		/// <summary>Extension of vectors index file </summary>
		public /*internal*/ const string VECTORS_INDEX_EXTENSION = "tvx";
		
		/// <summary>Extension of compound file </summary>
		public /*internal*/ const string COMPOUND_FILE_EXTENSION = "cfs";
		
		/// <summary>Extension of compound file for doc store files</summary>
		public /*internal*/ const string COMPOUND_FILE_STORE_EXTENSION = "cfx";
		
		/// <summary>Extension of deletes </summary>
		internal const string DELETES_EXTENSION = "del";
		
		/// <summary>Extension of field infos </summary>
		public /*internal*/ const string FIELD_INFOS_EXTENSION = "fnm";
		
		/// <summary>Extension of plain norms </summary>
		public /*internal*/ const string PLAIN_NORMS_EXTENSION = "f";
		
		/// <summary>Extension of separate norms </summary>
		public /*internal*/ const string SEPARATE_NORMS_EXTENSION = "s";
		
		/// <summary>Extension of gen file </summary>
		public /*internal*/ const string GEN_EXTENSION = "gen";
		...
		/// filename extension.
		/// </summary>
		public /*internal*/ static readonly string[] INDEX_EXTENSIONS = new string[]{COMPOUND_FILE_EXTENSION, FIELD_INFOS_EXTENSION, FIELDS_INDEX_EXTENSION, FIELDS_EXTENSION, TERMS_INDEX_EXTENSION, TERMS_EXTENSION, FREQ_EXTENSION, PROX_EXTENSION, DELETES_EXTENSION, VECTORS_INDEX_EXTENSION, VECTORS_DOCUMENTS_EXTENSION, VECTORS_FIELDS_EXTENSION, GEN_EXTENSION, NORMS_EXTENSION, COMPOUND_FILE_STORE_EXTENSION};
		
		/// <summary>File extensions that are added to a compound file
		/// (same as above, minus "del", "gen", "cfs"). 
		/// </summary>
		public /*internal*/ static readonly string[] INDEX_EXTENSIONS_IN_COMPOUND_FILE = new string[]{FIELD_INFOS_EXTENSION, FIELDS_INDEX_EXTENSION, FIELDS_EXTENSION, TERMS_INDEX_EXTENSION, TERMS_EXTENSION, FREQ_EXTENSION, PROX_EXTENSION, VECTORS_INDEX_EXTENSION, VECTORS_DOCUMENTS_EXTENSION, VECTORS_FIELDS_EXTENSION, NORMS_EXTENSION};
		
		public /*internal*/ static readonly string[] STORE_INDEX_EXTENSIONS = new string[]{VECTORS_INDEX_EXTENSION, VECTORS_FIELDS_EXTENSION, VECTORS_DOCUMENTS_EXTENSION, FIELDS_INDEX_EXTENSION, FIELDS_EXTENSION};
		
		public /*internal*/ static readonly string[] NON_STORE_INDEX_EXTENSIONS = new string[]{FIELD_INFOS_EXTENSION, FREQ_EXTENSION, PROX_EXTENSION, TERMS_EXTENSION, TERMS_INDEX_EXTENSION, NORMS_EXTENSION};
		
		/// <summary>File extensions of old-style index files </summary>
		public /*internal*/ static readonly string[] COMPOUND_EXTENSIONS = new string[]{FIELD_INFOS_EXTENSION, FREQ_EXTENSION, PROX_EXTENSION, FIELDS_INDEX_EXTENSION, FIELDS_EXTENSION, TERMS_INDEX_EXTENSION, TERMS_EXTENSION};
		
		/// <summary>File extensions for term vector support </summary>
		public /*internal*/ static readonly string[] VECTOR_EXTENSIONS = new string[]{VECTORS_INDEX_EXTENSION, VECTORS_DOCUMENTS_EXTENSION, VECTORS_FIELDS_EXTENSION};
		...
		/// </param>
		public /*internal*/ static string FileNameFromGeneration(string base_Renamed, string extension, long gen)
		{
