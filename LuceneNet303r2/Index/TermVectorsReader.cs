...
namespace Lucene.Net.Index
{
	class TermVectorsReader : System.ICloneable, IDisposable
	{
	    ...
	    internal TermVectorsReader(Directory d, string segment, FieldInfos fieldInfos):this(d, segment, fieldInfos, BufferedIndexInput.BUFFER_SIZE)
		{
		}
		
		internal TermVectorsReader(Directory d, string segment, FieldInfos fieldInfos, int readBufferSize):this(d, segment, fieldInfos, readBufferSize, - 1, 0)
		{
		}
		...
		public /*internal*/ virtual ITermFreqVector Get(int docNum, string field)
		{
